...
Ecommerce for **Rebozos Mary** — Mexican artisanal shawls. Built on Next.js 14 (App Router) + Payload CMS v3 running together in one process, backed by PostgreSQL (Supabase), with Stripe for payments (cards + OXXO, Mexico).
